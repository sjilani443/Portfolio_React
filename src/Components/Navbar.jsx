...
function Navbar() {
  return (
    <nav className='fixed top-0 h-16 sm:h-25 w-full flex justify-between items-center pt-4 sm:text-2xl sm:px-28 mb-10 font-space bg-[#023047] py-5 text-white'>
       <Link  to='/'> <img src={portlogo} alt="" className='h-10 sm:h-14 sm:w-26' /></Link>
      <div className='flex pr-5 gap-4 text-md sm:gap-10 font-poppins'>
