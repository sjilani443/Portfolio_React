    ...
    <div className='sm:px-20 sm:my-20 sm:mx-10 font-poppins mx-5 mb-5'>
      ...
      <div>
        <div>
            ...
            <a className='sm:text-xl underline sm:ml-10' target="_blank" href="https://recipe-heaven-frontend-app.vercel.app/">Link to the Website : recipe-heaven-frontend-app.vercel.app/</a>
        </div>
        <div className='mt-10'>
            <p className='text-2xl pb-3'>Saregama</p>
      ...
      <div className='mt-10 mb-10'>
            <p className='text-2xl pb-3'>Film-Vault</p>
